...
public class ComprasVista extends javax.swing.JPanel {
    ...
    private List<ComprasDetalleEntity> comprasCache = new ArrayList<>();
    ...
    private void inicializarLogica() {
        modelo = new DefaultTableModel(
                new String[]{"No", "No.Factura", "Fecha", "Producto", "Cant.",
        ...
        cargarDatos();
        btnAgregar.addActionListener(e -> UiUtil.abrirFrame(new FormularioAgregarCompraVista(), "Nueva Compra", 1100, 620));
    ...
    private void cargarDatos() {
        ...
        comprasCache = controller.listarComprasDetalle();
        int no = 1;
        for (ComprasDetalleEntity c : comprasCache) {
    ...
    private void editarSeleccionado() {
        ...
        if (fila >= 0 && fila < comprasCache.size()) {
            int id = comprasCache.get(fila).getIdCompra();
            UiUtil.abrirFrame(new FormularioEditarCompraVista(id), "Editar Compra");
        }
    }

    private void eliminarSeleccionado() {
        int fila = UiUtil.obtenerFilaSeleccionada(tablaCompras);
        if (fila >= 0 && fila < comprasCache.size() && UiUtil.confirmarEliminar(this)) {
            int id = comprasCache.get(fila).getIdCompra();
    ...
    private void initComponents() {
        ...
        tablaCompras.setModel(new javax.swing.table.DefaultTableModel(
            new Object[][]{},
            new String[]{"No", "No.Factura", "Fecha", "Producto", "Cant.", "Metodo", "Precio", "Subtotal", "ISV", "Total"}
        ));
